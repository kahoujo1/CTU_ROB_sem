...
class SE3:
    ...
    def __mul__(self, other: SE3) -> SE3:
        ...
        res = SE3()
        res.rotation = self.rotation * other.rotation
        res.translation = self.rotation.act(other.translation) + self.translation
        return res
    ...
    def inverse(self) -> SE3:
        ...
        res = SE3()
        res.rotation = self.rotation.inverse()
        res.translation = -res.rotation.act(
            self.translation
        )  # the rotation is inversed from previous line
        return res
    ...
    def to_dict(self):
        return {
            "rotation_matrix": self.rotation.log().tolist(),
